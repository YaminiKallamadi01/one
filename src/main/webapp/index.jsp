...
<h1 style="color: black; font-size: 40px;" align="center">THIS  IS JENKINS INTEGRATION WITH NEXUS</h1>
<h1 style="color: pink; font-size: 40px;" align="center">THIS IS SECOND VERSION</h1>
